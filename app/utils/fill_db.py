...
def fill_database() -> None:
    ...
    session.add(Products(name='Рождественские пряники',
                         ...
                         price=25.7,
                         quantity=54,
                         img_path=PLACEHOLDERS_DIR.joinpath('christmas.jpg'),
                         is_active=True))
    session.add(Products(name='Классические пряники',
                         ...
                         price=15.2,
                         quantity=13,
                         img_path=PLACEHOLDERS_DIR.joinpath('classic.jpg'),
                         is_active=True))
    session.add(Products(name='Цветочные пряники',
                         ...
                         price=7,
                         quantity=13,
                         img_path=PLACEHOLDERS_DIR.joinpath('flowers.jpg'),
                         is_active=True))
    session.add(Products(name='Пряники к 8 марту',
                         ...
                         price=21,
                         quantity=13,
                         img_path=PLACEHOLDERS_DIR.joinpath('for_girls.jpg'),
                         is_active=True))
    session.add(Products(name='Пряничные человечки',
                         ...
                         price=35,
                         quantity=34,
                         img_path=PLACEHOLDERS_DIR.joinpath('humans.jpg'),
                         is_active=True))
    session.add(Products(name='Волшебные зверюшки',
                         ...
                         price=40,
                         quantity=34,
                         img_path=PLACEHOLDERS_DIR.joinpath('magical_animals.jpg'),
                         is_active=True))
    session.add(Products(name='Пряничные солдатики',
                         ...
                         price=32,
                         quantity=34,
                         img_path=PLACEHOLDERS_DIR.joinpath('soldiers.jpg'),
                         is_active=True))
    session.add(Products(name='Пряники на 23 февраля',
                         title='Имбирные пряничные солдатики с глазурью – пряные, ароматные, хрустящие и очень вкусные.',
                         price=23,
                         quantity=23,
                         img_path=PLACEHOLDERS_DIR.joinpath('war_theme.jpg'),
                         is_active=True))
    session.commit()